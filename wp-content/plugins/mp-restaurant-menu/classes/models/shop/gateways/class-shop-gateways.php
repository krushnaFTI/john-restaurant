...
class Gateways extends Model {
	...
	public function get_payment_gateways() {
		...
		$gateways = array(
			...
			'stripe' => array(
				'admin_label' => __('Stripe Payment', ',p-restaurant-menu'),
				'checkout_label' => $this->get('settings')->get_option('stripe_title', __('Credit Card', 'mp-restaurant-menu')),
				'checkout_description' => $this->get('settings')->get_option('strip_description', false),
			),
			'manual' => array(
				'admin_label' => __('Cash on delivery', 'mp-restaurant-menu'),
				'checkout_label' => $this->get('settings')->get_option('cod_title', __('Payment at pickup', 'mp-restaurant-menu')),
