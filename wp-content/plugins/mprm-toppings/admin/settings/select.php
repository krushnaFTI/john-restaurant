...
$defaults = array(
	...
	'placeholder' => null,
	'multiple' => false,
	'show_option_all' => _x('All', 'all dropdown items', 'mprm-toppings'),
	'show_option_none' => _x('None', 'no dropdown items', 'mprm-toppings'),
	'data_attr' => array(),
);
...
<select name="<?php echo esc_attr($args['name']) ?>" id="<?php esc_attr(mprm_sanitize_key((str_replace('-', '_', $args['id'])))) ?>" class="mprm-select <?php echo $class . $multiple ?>" data-placeholder="<?php echo $placeholder ?>" <?php echo $data_elements ?> >
	<?php
