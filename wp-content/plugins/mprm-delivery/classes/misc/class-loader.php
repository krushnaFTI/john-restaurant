<?php
namespace mprm_delivery\classes\misc;
/**
 * Class Loader
 *
 * @version 1.0.2
...
class MPRM_Loader {
	 ...
	 * @access protected
	 */
	protected $_namespace = 'mprm_delivery\classes';
	...
	public function __construct() {
		$this->modelDirectoryPath = MP_DE_PLUGIN_PATH . 'classes/models/' . PATH_SEPARATOR . MP_DE_PLUGIN_PATH . 'classes/models/parents/';
		$this->controllerDirectoryPath = MP_DE_PLUGIN_PATH . 'classes/controllers/';
		$this->defaultDirectoryPath = MP_DE_PLUGIN_PATH . 'classes/';
	}
	...
	public function load_class($class) {
		...
		$type = 'default';
		$matches = array();
		if ((bool)preg_match_all("/mprm_delivery(.*)?/", $class, $matches)) {
			if ((bool)preg_match_all("/mprm_delivery(.*)?classes(.*)?models/", $class, $matches)) {
				$type = 'model';
			} elseif ((bool)preg_match_all("/mprm_delivery(.*)?classes(.*)?controllers/", $class, $matches)) {
				$type = 'controller';
			}
