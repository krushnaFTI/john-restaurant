...
class Media extends Core {
		...
		$mprm_settings = array(
			...
			'gateways' => apply_filters('mprm_settings_gateways',
				array(
					...
					// 		'type' => 'text',
					// 		'size' => 'regular',
					// 		'std' => __('Stripe Payment', 'mp-restaurant-menu'),
					// 	),
					// 	'stripe_publishable_key' => array(
					// 		'id' => 'stripe_publishable_key',
					// 		'name' => __('Publishable Key', 'mp-restaurant-menu'),
					// 		'desc' => __('', 'mp-restaurant-menu'),
					// 		'type' => 'text',
					// 		'size' => 'regular',
					// 		'std' => __('', 'mp-restaurant-menu'),
					// 	),
					// 	'stripe_secret_key' => array(
					// 		'id' => 'stripe_secret_key',
					// 		'name' => __('Secret Key', 'mp-restaurant-menu'),
					// 		'desc' => __('', 'mp-restaurant-menu'),
					// 		'type' => 'text',
					// 		'size' => 'regular',
					// 		'std' => __('', 'mp-restaurant-menu'),
			...
			/** delivery list */
			'delivery' => apply_filters('delivery',
				array(
					'main' => array(
						'postmates_sandbox_key_text' => array(
							'id' => 'postmates_sandbox_key_text',
							'name' => __('Postmates Sandbox Key', 'mp-restaurant-menu'),
							'desc' => __('', 'mp-restaurant-menu'),
							'type' => 'text',
							'std' => __('Sandbox Key', 'mp-restaurant-menu'),
						),
						'postmates_customer_id_text' => array(
							'id' => 'postmates_customer_id_text',
							'name' => __('Postmates Customer ID', 'mp-restaurant-menu'),
							'desc' => __('', 'mp-restaurant-menu'),
							'type' => 'text',
							'std' => __('cus_', 'mp-restaurant-menu'),
						)
					)
				)
			)
	...
	public function get_registered_settings_sections() {
		...
		$sections = array(
			...
			'gateways' => apply_filters('mprm_settings_sections_gateways', array(
				...
				// 'stripe' => __('Stripe Payment', 'mp-restaurant-menu'),
			...
			'delivery' => apply_filters('mprm_settings_sections_delivery', array(
				'main' => __('Main', 'mp-restaurant-menu')
			)),
		);
	...
	private function add_theme_css() {
		...
		//$this->enqueue_script('mp-restaurant-stripe', "libs/checkout.js");
		// $this->enqueue_script('mp-restaurant-stripe', "libs/checkout.js");
		$this->enqueue_script('mp-stripe-custom', "libs/stripe-custom.js");

		// $option_settings = get_option( 'mprm_settings' );
		// $publishable_key_stripe = $option_settings['stripe_publishable_key'];
		// $secret_key_stripe = $option_settings['stripe_secret_key'];

		// $translation_array = array(
		// 	'publishable_string' => $publishable_key_stripe,
		// 	'secret_string' => $secret_key_stripe
		// );
		// wp_localize_script( 'mp-stripe-custom', 'object_name', $translation_array );
	...
	public function get_settings_tabs() {
		...
		$tabs[ 'delivery' ] = _x('Delivery', 'Delivery settings tab', 'mp-restaurant-menu');
