		...
		return {
			...
			addToppingToCart: function () {
				...
				$(document).on('click', '.mprm-topping-add-to-cart', function (event) {
					...
					var priceID = jQuery(this).attr('data-price-val');

					var topping_tot = 0, topping_custom_total = 0;
					...
					$.each(inputs, function (index, input) {
						...
						switch (type) {
							...
							case 'checkbox':
								...
								checked = inputObject.attr('checked', 'checked');
								//var type = inputObject.attr('type');
					...
					topping_custom_total = parseInt(topping_tot) + parseInt(priceID);

					//jQuery('.mprm-custom-tot-price').html('$'+topping_custom_total.toFixed(2));
					...
					var $params = {
						...
						topping_total: topping_custom_total,
					...
					MP_RM_Registry._get('MP_RM_Functions').wpAjax($params,
						...
						function (data) {
							...
							jQuery('.topping-popup-content-data').hide(); // when toping added cart remove popup
