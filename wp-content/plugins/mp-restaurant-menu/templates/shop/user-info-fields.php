...
$get_error_full = $_SERVER['HTTP_REFERER'];
$get_error_full_url = str_replace('%20', ' ', $get_error_full);
$url_components = parse_url($get_error_full_url);
parse_str($url_components['query'], $params); ?>
	...
	<fieldset id="mprm_checkout_user_info">
		...
		<div style="color:red;">
			...
			if($params['error2'] == "unknown_location" || $params['error2'] == 'invalid_params'){
				echo "Invalid Address";
			}else if($params['error2'] == "undeliverable_address"){
				echo "Undeliverable Address";
			} ?>
		</div>
