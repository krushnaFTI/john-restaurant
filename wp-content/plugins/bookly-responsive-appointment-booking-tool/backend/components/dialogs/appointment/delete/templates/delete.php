    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?php //esc_html_e( 'You are going to delete appointment(s). Notifications will be sent in accordance with your settings.', 'bookly' )
                esc_html_e( 'You are going to delete appointment(s).', 'bookly' ) ?></p>
