...
class MPRM_Loader {
	 ...
	 * @access protected
	 */
	protected $_namespace = 'mprm_toppings\classes';
	...
	public function __construct() {
		$this->modelDirectoryPath = MP_TO_PLUGIN_PATH . 'classes/models/' . PATH_SEPARATOR . MP_TO_PLUGIN_PATH . 'classes/models/parents/';
		$this->controllerDirectoryPath = MP_TO_PLUGIN_PATH . 'classes/controllers/';
		$this->defaultDirectoryPath = MP_TO_PLUGIN_PATH . 'classes/';
	}
	...
	public function load_class($class) {
		...
		$type = 'default';
		$matches = array();
		if ((bool)preg_match_all("/mprm_toppings(.*)?/", $class, $matches)) {
			if ((bool)preg_match_all("/mprm_toppings(.*)?classes(.*)?models/", $class, $matches)) {
				$type = 'model';
			} elseif ((bool)preg_match_all("/mprm_toppings(.*)?classes(.*)?controllers/", $class, $matches)) {
				$type = 'controller';
			}
