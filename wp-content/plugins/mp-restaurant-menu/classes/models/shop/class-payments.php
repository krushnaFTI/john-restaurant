...
//		}
	...
	public function get_payment_statuses() {
		...
		$payment_statuses = array(
			...
			'publish' => __('Urgency', 'mp-restaurant-menu'),

			'mprm-refunded' => __('Refunded', 'mp-restaurant-menu'),

			'mprm-failed' => __('Failed', 'mp-restaurant-menu'),

			//'mprm-cooking' => __('On the way', 'mp-restaurant-menu'),

			'mprm-shipping' => __('On the way', 'mp-restaurant-menu'),

			//'mprm-urgency' => __('Urgency', 'mp-restaurant-menu'),

			'mprm-shipped' => __('Delivered', 'mp-restaurant-menu'),
