...
class Post extends Module {
	...
	public static function register_post_status() {
		...
		// 	'label' => _x('On the way', 'Order status', 'mp-restaurant-menu'),
		...
		// 	'label_count' => _n_noop('On the way <span class="count">(%s)</span>', 'On the way <span class="count">(%s)</span>', 'mp-restaurant-menu')
		...
		// register_post_status('mprm-urgency', array(

		// 	'label' => _x('Urgency', 'Order status', 'mp-restaurant-menu'),
		...
		// 	'label_count' => _n_noop('Urgency <span class="count">(%s)</span>', 'Urgency <span class="count">(%s)</span>', 'mp-restaurant-menu')
		...
		register_post_status('mprm-shipped', array(
			...
			'label' => _x('Delivered', 'Order status', 'mp-restaurant-menu'),
			...
			'label_count' => _n_noop('Delivered <span class="count">(%s)</span>', 'Delivered <span class="count">(%s)</span>', 'mp-restaurant-menu')
