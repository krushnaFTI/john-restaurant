...
class Settings extends Model {
	...
	public function get_settings($key = false) {
		...
		if (empty($settings)) {
			...
			$delivery_services_settings = is_array(get_option('mprm_settings_delivery_services')) ? get_option('mprm_settings_delivery_services') : array();
			$settings = array_merge($general_settings, $gateway_settings, $email_settings, $style_settings, $tax_settings, $ext_settings, $license_settings, $misc_settings, $default_settings, $delivery_services_settings);
